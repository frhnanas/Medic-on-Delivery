        ...
        <tbody>
          ...
          <tr>
            <form action="">
              ...
              <td><a type="button" class="btn btn-danger"  href="<?= site_url('admin/deleteakun/') . $d->akun_id; ?>" onClick="return confirm('Hapus Akun?')" ><i class="fas fa-user-times"></i>Delete</a></td>
            </form>
          </tr>
          <?php } ?>
        </tbody>
